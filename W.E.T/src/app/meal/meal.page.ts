...
export class MealPage implements OnInit {
  ...
  shareMeal(meal) {
    var options = {
      message: 'Check out this delicious meal', // not supported on some apps (Facebook, Instagram)
      subject: meal.strMeal, // fi. for email
      files: [meal.strMealThumb], // an array of filenames either locally or remotely
